...
"[project]/app/api/video/stream/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const { data: tokenData, error: tokenError } = await supabase.from("video_access_tokens").select("*").eq("token", token).eq("recording_id", recordingId).eq("revoked", false).single();
    if (tokenError || !tokenData) {
        console.error("[v0] Invalid token:", tokenError?.message);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Ugyldig eller utløpt tilgangstoken"
        }, {
            status: 403
        });
    }
    ...
    if (new Date(tokenData.expires_at) < new Date()) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Tilgangstoken har utløpt"
        }, {
            status: 403
        });
    }
    // Get the recording's Jottacloud URL
    const { data: recording, error: recordingError } = await supabase.from("recordings").select("jottacloud_embed_url").eq("id", recordingId).single();
    ...
    if (!recording.jottacloud_embed_url) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Ingen video tilgjengelig for dette opptaket"
        }, {
            status: 404
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d81b9f2._.js.map