...
"[project]/app/api/admin/verify-ticket/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const serverSupabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSupabaseServerClient"])();
        ...
        if (qrData) {
            ...
            try {
                ...
                if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyQRSignature"])(dataWithoutSignature, signature)) {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                        status: "error",
        ...
        `).eq("booking_reference", bookingReference).single();
            booking = data;
        }
        if (!booking) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        // Check show date
        const showDate = new Date(booking.show?.show_datetime);
        const now = new Date();
        ...
        const showTitle = booking.show?.title || booking.show?.ensemble?.title || "Forestilling";
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status,
            message,
            booking: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5d6b08c6._.js.map