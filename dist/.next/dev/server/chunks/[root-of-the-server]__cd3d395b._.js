...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sib$2d$api$2d$v3$2d$sdk$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/sib-api-v3-sdk/src/index.js [app-route] (ecmascript)");
;
;
async function sendTicketEmail(data) {
    ...
    if (!brevoApiKey) {
        ...
        return {
            success: false,
            error: "E-post er ikke konfigurert (mangler BREVO_API_KEY)"
        };
    }
    try {
        // Initialize Brevo client
        console.log("[v0] Initializing Brevo client...");
        const defaultClient = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sib$2d$api$2d$v3$2d$sdk$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiClient"].instance;
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5;">
  <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    `;
        console.log("[v0] Preparing Brevo email request...");
        const transactionalEmailsApi = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sib$2d$api$2d$v3$2d$sdk$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TransactionalEmailsApi"]();
        const sendSmtpEmail = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sib$2d$api$2d$v3$2d$sdk$2f$src$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SendSmtpEmail"]();
        sendSmtpEmail.subject = `Din billett til ${data.showTitle} - ${data.bookingReference}`;
        ...
        console.log("[v0] - Subject:", sendSmtpEmail.subject);
        const response = await transactionalEmailsApi.sendTransacEmail(sendSmtpEmail);
        console.log("[v0] Email sent successfully!");
        console.log("[v0] Message ID:", response.messageId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cd3d395b._.js.map