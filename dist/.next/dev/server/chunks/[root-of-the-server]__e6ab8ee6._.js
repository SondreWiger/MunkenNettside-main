...
"[project]/app/api/seats/cleanup/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { error: expiredError } = await supabase.from("seats").update({
            status: "available",
            reserved_until: null
        }).lt("reserved_until", now).eq("status", "reserved");
        // Also clear seats with null reserved_until but status reserved (cleanup)
        const { error: nullReservedError } = await supabase.from("seats").update({
            status: "available",
            reserved_until: null
        }).is("reserved_until", null).eq("status", "reserved");
        if (expiredError || nullReservedError) {
            console.error("[v0] Seats cleanup error:", {
                expiredError,
                nullReservedError
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "Kunne ikke rense setereservasjoner"
            }, {
                status: 500
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e6ab8ee6._.js.map