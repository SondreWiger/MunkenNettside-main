...
"[project]/app/admin/rabattkoder/ny/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NewDiscountCodePage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Rabattkode opprettet!");
            router.push("/admin/rabattkoder");
        } catch (err) {
            const message = err instanceof Error ? err.message : "Ukjent feil";
            console.error("[v0] Error:", message);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(`Kunne ikke opprette rabattkode: ${message}`);
        } finally{
            setIsLoading(false);
        }
    };
...
//# sourceMappingURL=_5dd558de._.js.map